...
export const translations = {
  en: {
    ...
    licenses: {
      ...
      subtitle: "Centralized establishment management and access",
      ...
      activate: "Activate",
      revoke: "Revoke",
      search: "Search establishment...",
      noLicenses: "No licenses registered",
    },
    alerts: {
      stockLow: "Low Stock Alert",
      stockLowDesc: "Only {count} units remaining",
      reorder: "Reorder",
      dismiss: "Dismiss",
      critical: "Critical",
      warning: "Warning",
  ...
  es: {
    ...
    licenses: {
      ...
      subtitle: "Gestión centralizada de establecimientos y acceso",
      ...
      noLicenses: "Sin licencias registradas",
    },
    alerts: {
      stockLow: "Alerta de Stock Bajo",
      stockLowDesc: "Solo quedan {count} unidades",
      reorder: "Reordenar",
      dismiss: "Descartar",
      critical: "Crítico",
      warning: "Advertencia",
